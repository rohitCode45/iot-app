...
function Sidebar() {
  ...
  return (
    <div className={`sidebar-toogle-icon-container`}>
      <div className={`sidebar-main-conatiner ${sidebarMinimized ? 'sidebarMinimized' : ''}`}>
      ...
      <div className="sidebar-toggle-icon-container">
        <span onClick={() => { toggleSideBar() }} title={sidebarMinimized ? 'Expand Sidebar' : 'Minimize sidebar'} className="sidebar-toggle-icon">
          <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M9 6 3 12 9 18V6ZM15 18 21 12 15 6V18Z"></path></svg>
        </span>
      </div>
    </div>
