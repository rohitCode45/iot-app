...
export const telemetryPageInfo = {
  ...
  "/SI_TRKSEC": {
    ...
    dummyData: [
      { "type": "SI_TRKSEC", "name": "C98XT", "trackSectionOccupiedOrClear": "clear", "trackSectionError": "error", "trackSectionBlockedByEI": "blockedByEI", "hexVal": "11", "hexValOpt": "11", dummykey1: 'aaa', dummykey2: 'gdhjdgjhg' },
    ],
  },
  "/SI_LCGATE": {
    id: 'SI_LCGATE',
